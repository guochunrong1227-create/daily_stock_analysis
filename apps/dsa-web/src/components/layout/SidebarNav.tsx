...
import { BarChart3, BriefcaseBusiness, Home, LogOut, MessageSquareQuote, SearchCodeIcon, SearchXIcon, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'strategy', label: '选策', to: '/strategy', icon:SearchXIcon },
  { key: 'stockQuery', label: '选股', to: '/stockQuery', icon:SearchCodeIcon },
